...
export class AddUsermanagmentComponent implements OnInit {
 ...
 roles:any=[
  {label:'All', value:'All',check:''},
   {label:'Approve', value:'ROLE_CUSTOMER_APPROVE',check:''}, 
   {label:'Upload', value:'ROLE_CUSTOMER_UPLOAD',check:''}, 
   {label:'Read', value:'ROLE_CUSTOMER_READ',check:''}, 
   {label:'Add Users', value:'ROLE_CUSTOMER_ADD_USERS',check:''}, 
   {label:'Reports', value:'ROLE_CUSTOMER_REPORTS',check:''}
 ]
 ...
 departments:any=[
  ...
  userForm=this.formBuilder.group({
    ...
    email:["",[Validators.required,noExtraWhiteSpace,email]],
    mobileNumber:['',[Validators.required,noSpecialCharAllow]],
